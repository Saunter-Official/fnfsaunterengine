        ...
        return {
          ...
          blocks: [
            ...
            //deprecated
            {
              ...
              arguments: {
                COLOR_TYPE: { type: Scratch.ArgumentType.STRING, menu: "elementMenu" }, COLOR1: { type: Scratch.ArgumentType.COLOR }, COLOR2: { type: Scratch.ArgumentType.COLOR }, DIR: { type: Scratch.ArgumentType.ANGLE }
              },
            }, {
              ...
              hideFromPalette: true,
              arguments: {
                COLOR_TYPE: { type: Scratch.ArgumentType.STRING, menu: "elementMenu" }, COLOR1: { type: Scratch.ArgumentType.COLOR }, COLOR2: { type: Scratch.ArgumentType.COLOR }, X: { type: Scratch.ArgumentType.NUMBER }, Y: { type: Scratch.ArgumentType.NUMBER }
              },
            }, {
              opcode: "setEnable", blockType: Scratch.BlockType.COMMAND,
              hideFromPalette: true, text: "set [ENABLE_MENU] to be [ACTION]",
              arguments: {
                ENABLE_MENU: { type: Scratch.ArgumentType.STRING, menu: "enableMenu" }, ACTION: { type: Scratch.ArgumentType.STRING, menu: "inputActionMenu" }
              },
            }, {
              opcode: "getBoxCount", blockType: Scratch.BlockType.REPORTER, hideFromPalette: true, text: "box count"
            }, {
