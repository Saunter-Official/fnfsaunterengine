...
/* generated l10n code */Scratch.translate.setup({"de":{"_Clipping & Blending":"Ränder verändern & Farben mischen"},"fi":{"_Clipping & Blending":"Leikkaaminen ja sekoitus","_additive":"additiivista","_blending":"sekoitus","_clear clipping box":"poista leikkauslaatikko","_clipping box [PROP]":"leikkauslaatikon [PROP]","_default":"oletus","_height":"korkeus","_invert":"käänteis","_is additive blending on?":"onko additiivinen sekoitus päällä?","_max x":"suurin x-sijainti","_max y":"suurin y-sijainti","_min x":"pienin x-sijainti","_min y":"pienin y-sijainti","_multiply":"monistus","_off":"pois päältä","_on":"päälle","_set clipping box x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]":"aseta leikkauslaatikoksi x1: [X1] y1: [Y1] x2: [X2] y2: [Y2]","_subtract":"vähennys","_turn additive blending [STATE]":"kytke additiivinen sekoitus [STATE]","_use [BLENDMODE] blending":"käytä [BLENDMODE] sekoitusta","_width":"leveys"},"it":{"_Clipping & Blending":"Ritaglio e Fusione","_height":"altezza","_off":"disabilita","_on":"abilita","_width":"larghezza"},"ja":{"_default":"黙認","_height":"高さ","_invert":"色の反転","_off":"オフ","_on":"オン","_width":"横幅"},"ko":{"_Clipping & Blending":"클리핑 및 블렌딩","_additive":"더하기","_blending":"블렌딩","_clear clipping box":"클리핑 영역 초기화","_clipping box [PROP]":"클리핑 영역 [PROP]","_default":"기본","_height":"높이","_invert":"반전","_is additive blending on?":"더하기 블렌딩이 켜져있는가?","_max x":"최대 x","_max y":"최대 y","_min x":"최소 x","_min y":"최소 y","_multiply":"곱하기","_off":"끄기","_on":"켜기","_set clipping box x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]":"클리핑 영역을 x1:[X1] y1:[Y1] x2:[X2] y2:[Y2] (으)로 정하기","_subtract":"빼기","_turn additive blending [STATE]":"더하기 블렌딩 [STATE]","_use [BLENDMODE] blending":"[BLENDMODE] 블렌딩하기","_width":"넓이"},"nb":{"_Clipping & Blending":"Klipping og blanding","_height":"høyde","_off":"av","_on":"på","_width":"bredde"},"nl":{"_Clipping & Blending":"Knippen & mengen","_default":"standaard","_height":"hoogte","_invert":"omgekeerd","_off":"uit","_on":"aan","_width":"breedte"},"pl":{"_height":"wysokość","_width":"szerokość"},"ru":{"_Clipping & Blending":"Обрезка и Смешивание","_additive":"прибавление","_blending":"смешивание","_clear clipping box":"отчистить рамку отсечения","_clipping box [PROP]":"[PROP] рамки отсечения","_default":"по умолчанию","_height":"высота","_invert":"инверт","_is additive blending on?":"включено ли смешивание прибавление?","_max x":"максимальный x","_max y":"максимальный y","_min x":"минимальный x","_min y":"минимальный y","_multiply":"умножение","_off":"выключить","_on":"включить","_set clipping box x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]":"задать рамку отсечения x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]","_subtract":"вычитание","_turn additive blending [STATE]":"включить режим смешивания прибавление [STATE]","_use [BLENDMODE] blending":"использовать режим смешивания [BLENDMODE]","_width":"ширина"},"tr":{"_Clipping & Blending":"Kırpma ve Karıştırma"},"uk":{"_Clipping & Blending":"Обрізання та Змішування","_height":"висота","_off":"вимкнути","_on":"увімкнути","_width":"ширина"},"zh-cn":{"_Clipping & Blending":"裁剪与颜色混合","_additive":"加法","_blending":"混合模式","_clear clipping box":"清除裁剪框","_clipping box [PROP]":"裁剪框[PROP]","_default":"默认类型","_height":"高度","_invert":"反色","_is additive blending on?":"加法混合开启？","_max x":"右x","_max y":"上y","_min x":"左x","_min y":"下y","_multiply":"正片叠底","_off":"关闭","_on":"打开","_set clipping box x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]":"设置裁剪框 x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]","_subtract":"差值","_turn additive blending [STATE]":"加法混合 [STATE]","_use [BLENDMODE] blending":"使用[BLENDMODE]混合模式","_width":"宽度"}});/* end generated l10n code */(function (Scratch) {
    "use strict";
